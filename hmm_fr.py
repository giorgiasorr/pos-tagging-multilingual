...
# Reading French training and test data
train_sentences = read_data("fr_train.col")
test_sentences = read_data("fr_test.col")
...
write_output('output_hmm_fr.col', tagged_seq)
"""
