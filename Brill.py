...
###### ENGLISH ######
train_file = os.path.join(sys.path[0], "en_train.col")
gold_standard_file = os.path.join(sys.path[0], "en_test.col")
L_train_file = os.path.join(sys.path[0], "en_test.col")
    ...
    with open(file2_path, "r") as file2:
        for line in file2:
            ...
            if word in word_to_tag:
                ...
                mapped_words.append(
                    (word, "UNK")
                )  # using 'UNK' (unknown) as a placeholder if the word is not found in file
